...
const EN: Bundle = {
  ...
  boxOpen: 'Open box',
  boxEmptySlot: 'empty',
  boxSaveHere: 'Save current here',
  boxTakeOut: 'Take out',
  boxDelete: 'Delete',
  boxConfirmSave: 'Save current pet to this slot? A new egg will start.',
  boxConfirmTakeOut: 'Take this pet out? Current pet will be parked in an empty slot.',
  boxConfirmDelete: 'Delete this pet from the box? This cannot be undone.',
  boxBlockedEgg: 'Eggs cannot be put in the box.',
  boxBlockedRip: 'R.I.P. pets cannot be put in the box — reset first.',
  boxBlockedBusy: 'Cannot use the box while a pomodoro is in progress.',
  boxBlockedFull: 'The box is full — delete a slot first.',
}
...
const KO: Bundle = {
  ...
  boxTakeOut: '꺼내기',
  boxDelete: '삭제',
  boxConfirmSave: '현재 펫을 이 칸에 보관할까요? 새 알이 시작됩니다.',
  boxConfirmTakeOut: '이 펫을 꺼낼까요? 현재 펫은 박스 빈 칸으로 이동합니다.',
  boxConfirmDelete: '박스의 이 펫을 삭제할까요? 되돌릴 수 없습니다.',
  boxBlockedEgg: '알 단계에서는 박스를 사용할 수 없어요.',
  boxBlockedRip: '죽은 펫은 박스에 보관할 수 없어요 — 먼저 리셋해주세요.',
  boxBlockedBusy: '포모도로 진행 중에는 박스를 사용할 수 없어요.',
  boxBlockedFull: '박스가 가득 찼어요 — 하나를 삭제하세요.',
